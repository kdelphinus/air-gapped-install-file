# Apache Kafka v3.9.0 (KRaft Mode) Air-Gapped Asset

본 디렉토리는 폐쇄망(Air-Gapped) Kubernetes 환경에서 고가용성을 보장하며 즉시 운영 가능한 Apache Kafka v3.9.0 클러스터 설치 자산입니다.
...
```text
kafka-3.9.0/
├── charts/          # Bitnami Kafka Helm 차트 (31.4.0)
...
- **Chart Version**: Bitnami Kafka 31.4.0
