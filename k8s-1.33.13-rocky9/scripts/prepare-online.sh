...
# ==========================================
# k8s-1.33.13-rocky9 온라인 사전 준비 스크립트 (Phase 1~3)
...
echo "[ERROR] This legacy online preparation script is disabled."
echo "        Collect offline assets with scripts/download_assets_offline.sh and install with scripts/install.sh."
exit 1
...
echo -e "${CYAN} 대상 OS : Rocky Linux 9${NC}"
echo -e "${CYAN}============================================================${NC}"
...
echo -e "  → SELinux Enforcing and firewalld preservation"
