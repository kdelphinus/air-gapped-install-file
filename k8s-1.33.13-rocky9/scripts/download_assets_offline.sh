...
K8S_REPO_FILE="/etc/yum.repos.d/kubernetes-v1.33-offline-collector.repo"
...
[kubernetes-v1.33-offline-collector]
name=Kubernetes v1.33 offline collector
