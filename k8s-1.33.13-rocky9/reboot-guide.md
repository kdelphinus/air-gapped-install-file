# Kubernetes v1.33.13 (Rocky Linux 9) 재부팅 운영 가이드

> **대상 환경**: Rocky Linux 9 + Kubernetes v1.33.13 (kubeadm) + containerd v2.2.x
> **작성일**: 2026-05-08
> **참고 가이드**: [install-guide-online.md](./install-guide-online.md)
...
> Rocky 9 은 기본 커널 5.14+ 와 systemd unified cgroup(v2) 부팅이므로 cgroup 강제 활성화 추가 절차는 불필요합니다.
