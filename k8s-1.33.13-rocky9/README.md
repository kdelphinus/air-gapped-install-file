# Kubernetes v1.33.13 Rocky 9 보안 설치 패키지

Rocky Linux 9 amd64에 Kubernetes `v1.33.13`을 설치하는 에어갭 패키지입니다. `K8s취약점_점검_가이드.pdf`의 Control Plane 및 Worker 점검 항목을 신규 설치 기본값에 반영합니다.
...
- 자동 CNI: Calico `v3.31.6`, L2/IPIP 기준
