...
본 문서는 **GitLab EE 18.11.4-ee.0** Omnibus 패키지를 기반으로 구축된 단일 파드 올인원(All-in-One) 인프라 명세를 정의합니다.
...
| 항목 | 버전 | 비고 |
| --- | --- | --- |
| **GitLab EE** | **18.11.4-ee.0** | Omnibus 올인원 이미지 |
| **PostgreSQL** | **16.x (혹은 17.x)** | GitLab 내장 DB |
